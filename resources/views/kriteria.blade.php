...
@section('konten')
    ...
    <div class="min-height-200px">
        <div class="page-header">
            <div class="row">
                ...
                <div class="col-md-6 col-sm-12 text-right">
                    <a href="kriteria-add" class="btn btn-primary" data-target="#tambah" role="button"
                                ...
                                <form action="post" enctype="multipart/form-data">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="type" class="form-control" name='keterangan' id="keterangan"
                                                required>
                                        </div>
                ...
                <tbody>
                    ...
                    @foreach ($data as $item)
                        <tr>
                            ...
                            {{-- <td> 
                        @foreach ($data->dokument as $dokument)
                        {{ $dokument['name'] }}
                         @endforeach
                     </td> --}}
                            <td>
        ...
        {{-- edit --}}
        <div class="row">
            <form action="/kriteria-edit/{{ $item->id }}" method="post">
                <div id="edit{{ $item->id }}" class="modal fade" role="dialog">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            @csrf
                            @method('PUT')
                            <form action="/kriteria-edit/{{ $item->id }}" method="get" enctype="multipart/form-data">
                                <div class="modal-body">
                                    <div class="from-group">
                                        <label class="control-label" for="name">Code</label>
                                        <input type="text" class="form-control" name='name' id="name"
            ...
            <div id="hapus{{ $item->id }}" class="modal fade" role="dialog">
                <div class="modal-dialog">
                    <div class="modal-content" style="padding: 20px">
                        ...
                        <div class="modal-fooder">
                            <form action="/kriteria-delete/{{ $item->id }}" style="display: inline-block"
                                method="delete">

                                <button type="submit" class="btn btn-danger">Ya</button>
                            </form>
                            <a href="/kriteria" class="btn btn-primary">Cencel</a>
                        </div>
                    </div>
                </div>
            </div>
